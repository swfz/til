...
type Query_allRelatedMarkdownRemarksArgs = {
  ...
  limit: InputMaybe<Scalars['Int']>;
  skip: InputMaybe<Scalars['Int']>;
  sort: InputMaybe<relatedMarkdownRemarksSortInput>;
};
...
type relatedMarkdownRemarksConnection_distinctArgs = {
  field: relatedMarkdownRemarksFieldsEnum;
};
...
type relatedMarkdownRemarksFieldsEnum =
  | 'children'
  | 'children.children'
  | 'children.children.children'
  | 'children.children.children.children'
  ...
  | 'posts.excerptAst'
  | 'posts.fields.slug'
  | 'posts.fileAbsolutePath'
  | 'posts.frontmatter.date'
  | 'posts.frontmatter.description'
  | 'posts.frontmatter.tags'
  | 'posts.frontmatter.title'
  | 'posts.headings'
  | 'posts.headings.depth'
  | 'posts.headings.id'
  | 'posts.headings.value'
  | 'posts.html'
  | 'posts.htmlAst'
  | 'posts.id'
  ...
  | 'posts.rawMarkdownBody'
  | 'posts.tableOfContents'
  | 'posts.timeToRead'
  | 'posts.wordCount.paragraphs'
  | 'posts.wordCount.sentences'
  | 'posts.wordCount.words';
...
type relatedMarkdownRemarksSortInput = {
  readonly fields: InputMaybe<ReadonlyArray<InputMaybe<relatedMarkdownRemarksFieldsEnum>>>;
  readonly order: InputMaybe<ReadonlyArray<InputMaybe<SortOrderEnum>>>;
};
...
type AllMarkdownQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly excerpt: string | null, readonly fields: { readonly slug: string }, readonly frontmatter: { readonly date: string, readonly title: string, readonly description: string, readonly tags: ReadonlyArray<string | null> } } }> } };

type ArchiveQueryQueryVariables = Exact<{ [key: string]: never; }>;


type ArchiveQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly date: string } } }> } };

type ArchivesByDateRangeQueryVariables = Exact<{
  startDate: InputMaybe<Scalars['Date']>;
  endDate: InputMaybe<Scalars['Date']>;
}>;


type ArchivesByDateRangeQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly allMarkdownRemark: { readonly totalCount: number, readonly edges: ReadonlyArray<{ readonly node: { readonly excerpt: string | null, readonly fields: { readonly slug: string }, readonly frontmatter: { readonly title: string, readonly date: string, readonly tags: ReadonlyArray<string | null>, readonly description: string } } }> } };
...
type BlogPostBySlugQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly markdownRemark: { readonly id: string, readonly excerpt: string | null, readonly html: string | null, readonly frontmatter: { readonly title: string, readonly date: string, readonly description: string, readonly tags: ReadonlyArray<string | null> } } | null, readonly relatedMarkdownRemarks: { readonly posts: ReadonlyArray<{ readonly frontmatter: { readonly title: string }, readonly fields: { readonly slug: string } } | null> | null } | null };
...
type MarkdownRemarkByTagQueryVariables = Exact<{
  tag: InputMaybe<Scalars['String']>;
}>;


type MarkdownRemarkByTagQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly allMarkdownRemark: { readonly totalCount: number, readonly edges: ReadonlyArray<{ readonly node: { readonly excerpt: string | null, readonly fields: { readonly slug: string }, readonly frontmatter: { readonly title: string, readonly date: string, readonly tags: ReadonlyArray<string | null>, readonly description: string } } }> } };

type SiteQueryVariables = Exact<{ [key: string]: never; }>;


type SiteQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null, readonly social: { readonly twitter: string | null } | null } | null } | null };
