...
export type SitePluginPluginOptions = {
  ...
  concurrentQueries?: Maybe<Scalars["Boolean"]>
  skipIndexing?: Maybe<Scalars["Boolean"]>
...
export type SitePluginPluginOptionsCodegenConfig = {
  resolverValidationOptions?: Maybe<SitePluginPluginOptionsCodegenConfigResolverValidationOptions>
}

export type SitePluginPluginOptionsCodegenConfigResolverValidationOptions = {
  requireResolversForResolveType?: Maybe<Scalars["Boolean"]>
}
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  concurrentQueries?: Maybe<BooleanQueryOperatorInput>
  skipIndexing?: Maybe<BooleanQueryOperatorInput>
  continueOnFailure?: Maybe<BooleanQueryOperatorInput>
...
export type SitePluginPluginOptionsCodegenConfigFilterInput = {
  resolverValidationOptions?: Maybe<SitePluginPluginOptionsCodegenConfigResolverValidationOptionsFilterInput>
}

export type SitePluginPluginOptionsCodegenConfigResolverValidationOptionsFilterInput = {
  requireResolversForResolveType?: Maybe<BooleanQueryOperatorInput>
}
...
export type SitePageFieldsEnum =
  ...
  | "pluginCreator___pluginOptions___concurrentQueries"
  | "pluginCreator___pluginOptions___skipIndexing"
  | "pluginCreator___pluginOptions___continueOnFailure"
...
export type SitePluginFieldsEnum =
  ...
  | "pluginOptions___codegenConfig___resolverValidationOptions___requireResolversForResolveType"
  ...
  | "pluginOptions___concurrentQueries"
  | "pluginOptions___skipIndexing"
  | "pluginOptions___continueOnFailure"
...
export type ArchiveQueryQueryVariables = Exact<{ [key: string]: never }>

export type ArchiveQueryQuery = {
  allMarkdownRemark: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, "date">> } }> }
}
...
export type BioQueryQuery = {
  avatar?: Maybe<{
    childImageSharp?: Maybe<{ fixed?: Maybe<Pick<ImageSharpFixed, "base64" | "width" | "height" | "src" | "srcSet">> }>
  }>
  site?: Maybe<{
    siteMetadata?: Maybe<{
...
export type SiteQuery = {
  site?: Maybe<{
    siteMetadata?: Maybe<
      Pick<SiteSiteMetadata, "title" | "description"> & { social?: Maybe<Pick<SiteSiteMetadataSocial, "twitter">> }
    >
  }>
}
...
export type TitleQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, "title">> }> }

export type AllMarkdownQueryVariables = Exact<{ [key: string]: never }>

export type AllMarkdownQuery = {
...
export type Unnamed_1_Query = {
  site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, "title">> }>
  allMarkdownRemark: { group: Array<Pick<MarkdownRemarkGroupConnection, "fieldValue" | "totalCount">> }
}
